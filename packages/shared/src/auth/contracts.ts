...
export type AuthAuditAction =
  ...
  | 'workspace.billing.warning_emitted'
  ...
  | 'knowledge.connector.checkpoint_updated'
  ...
  | 'workflow.definition.rolled_back'
  | 'workflow.definition.permissions_updated'
  | 'workflow.definition.dry_run'
  | 'workspace.run.branch_created'
  ...
  | 'admin.observability.annotation.created'
